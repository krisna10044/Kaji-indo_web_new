...
data-nominal-biaya="<?php echo e($k->nominal_biaya ?? ''); ?>"   
...
<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:10px;margin-bottom:18px">
    ...
    <select class="form-select" name="biaya" id="k-biaya" required onchange="toggleNominalBiaya(this.value)">
        <option value="" disabled selected>-- Pilih --</option>
        <option value="Gratis">Gratis</option>
        <option value="Berbayar">Berbayar</option>
    </select>
</div>
<div class="form-group" id="k-nominal-group" style="display:none">
    <label class="form-label">Nominal Biaya <span style="color:var(--accent2)">*</span></label>
    <div style="position:relative">
        <span style="position:absolute;left:12px;top:50%;transform:translateY(-50%);
                     font-size:13px;font-weight:600;color:var(--text-muted);pointer-events:none">
            Rp
        </span>
        <input class="form-input" type="number" name="nominal_biaya" id="k-nominal-biaya"
               placeholder="Contoh: 150000" min="0" step="1000"
               style="padding-left:38px">
    </div>
    <div class="form-hint">Masukkan nominal dalam Rupiah. Contoh: 150000 untuk Rp 150.000</div>
</div>
    </div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:18px">
    ...
    function toggleNominalBiaya(val) {
    const grup  = document.getElementById('k-nominal-group');
    const input = document.getElementById('k-nominal-biaya');
    if (val === 'Berbayar') {
...
function initProgramTimers() {
    ...
    document.addEventListener('click', function(e) {
        ...
        toggleNominalBiaya(d.biaya || '');
if (d.biaya === 'Berbayar' && d.nominalBiaya) {
    document.getElementById('k-nominal-biaya').value = d.nominalBiaya;
}
    ...
    function resetKurikulumModal() {
        ...
        document.getElementById('k-biaya').value = ''; 
         document.getElementById('k-nominal-biaya').value = '';   
    document.getElementById('k-nominal-group').style.display = 'none'; 
...
<div class="modal-overlay" id="modal-pulihkan-event">
    ...
    </html><?php /**PATH /home/infojawatimur/kajiindonesia.com_new/resources/views/trainer/dashboard.blade.php ENDPATH**/ ?>